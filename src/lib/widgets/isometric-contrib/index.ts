import * as aggregate from './core/aggregate-user-info';
import * as template from './theme/color-template';
import * as create from './core/create-svg';
import * as f from './utils/file-writer';
import * as r from './utils/settings-reader';
import * as client from './api/github-graphql';
