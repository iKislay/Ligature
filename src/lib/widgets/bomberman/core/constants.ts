...
export const BOMB_FUSE_FRAMES = 8;
export const BOMB_KICK_ROLL_INTERVAL_FRAMES = 2;
export const EXPLOSION_DURATION_FRAMES = 4;
export const MAX_FRAMES = 400;
export const BLAST_RANGE = 1;
export const BOMB_LIMIT = 1;
export const PLAYER_SPEED_UNITS = 100;
export const SPEED_ITEM_BONUS = 5;

export const ITEM_DROP_CHANCE_BY_LEVEL = {
	NONE: 0,
	FIRST_QUARTILE: 0.05,
	SECOND_QUARTILE: 0.1,
	THIRD_QUARTILE: 0.18,
...
export const ITEM_DROP_TARGET_EXPECTED_COUNT = 3;
export const ITEM_DROP_MAX_SPARSE_MULTIPLIER = 3;
...
export const DEATH_ANIMATION_FRAMES = 8;
export const PATH_BLAST_COST = BOMB_FUSE_FRAMES + 2;
